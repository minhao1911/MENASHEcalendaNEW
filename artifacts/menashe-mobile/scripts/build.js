...
async function startMetro(expoPublicDomain, expoPublicReplId) {
  ...
  console.log(`Setting EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY (length=${env.EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY.length})`);
  if (clerkProxyUrl) console.log(`Setting EXPO_PUBLIC_CLERK_PROXY_URL=${clerkProxyUrl}`);
