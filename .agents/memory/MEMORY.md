...
- [Memorial navigation (SPR-024)](memorial-navigation-spr024.md) — MemorialSanctuaryPage + MemorialProfilePage retired; "memorial" removed from Page type; onMemorial → setModal("community-yahrzeit") → CommunityYahrzeitModal → MemorialSanctuaryModal (3D).
